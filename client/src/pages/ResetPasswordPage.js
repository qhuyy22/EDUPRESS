...
import './ForgotPasswordPage.css'; // Dùng chung CSS
...
const ResetPasswordPage = () => {
    ...
    // Lấy token từ URL params (đã được định nghĩa trong AppRouter.js)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Đảm bảo token được gửi qua URL params, mật khẩu qua body
            const response = await axios.put(`/api/auth/reset-password/${token}`, { password }, config);
            
            setMessage(response.data.mes || 'Mật khẩu đã được cập nhật thành công.');
                ...
                <div className="forgot-card">
                    ...
                    {message ? (
                        <p className="redirect-note">
                            {message} Bạn sẽ được chuyển hướng về trang Đăng nhập sau vài giây...
                        </p>
                    ) : (
